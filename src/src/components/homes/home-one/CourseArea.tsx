...
const buildImageUrl = (fileName: string | null | undefined): string => {
   if (!fileName) return '/images/placeholder-link.png';
...
// =============================================
// COMPONENTE - CONSUME LINKSEXTERNOINTERNO ✨
// =============================================
const CourseArea: React.FC = () => {
   ...
   // =============================================
   // CARGAR DATOS DESDE API - linksExternoInterno
   // =============================================
   useEffect(() => {
      const fetchLinks = async () => {
         try {
            console.log('🔄 [CourseArea] Cargando linksExternoInterno desde API...');
   ...
   // =============================================
   // ESTILOS VISUALES - DINÁMICOS Y OSCUROS 🎨
   // =============================================
   const courseStyles = {
      section: {
         ...
         <section className="course-area pd-top-100 pd-bottom-90" style={courseStyles.section}>
            ...
            <div className="container text-center" style={{ position: 'relative', zIndex: 1 }}>
               ...
               <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '1.1rem' }}>
                  Obteniendo recursos de Sociología...
               </p>
            </div>
         </section>
      );
...
<div className="row justify-content-center mb-4" style={courseStyles.header}>
   <div className="col-xl-8 text-center">
      ...
      <p className="text-muted small mt-3" style={courseStyles.sectionDescription}>
         ...
         Enlaces y recursos externos de la Carrera de Sociología
      </p>
